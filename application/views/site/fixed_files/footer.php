    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                ...
                ?>
                <h5 class="title" style="color:<?php echo COR3;?>!important;"> NewCommerce </h5>
                <ul class="list alt-list">
                    <li ><a  href="<?php echo base_url('pagina/sobre-nos')?>" style="color:<?php echo COR3;?>!important;">Sobre Nós</a></li>
                    <li><a href="<?php echo base_url('pagina/como-funciona')?>" style="color:<?php echo COR3;?>!important;">Como Funciona</a></li>
                    <li><a href="<?php echo base_url('pagina/politica-privacidade')?>" style="color:<?php echo COR3;?>!important;">Pol&iacutetica de Privacidade</a></li>
                    <li><a href="<?php echo base_url('pagina/termos-de-uso')?>" style="color:<?php echo COR3;?>!important;">Termo de Uso</a></li>
                    <li><a href="<?php echo base_url('empresa')?>" style="color:<?php echo COR3;?>!important;">Acesso Empresas</a></li>
                    <li><a href="<?php echo base_url('contato')?>" style="color:<?php echo COR3;?>!important;">Contato</a></li>
                </ul>
            </div><!-- end col -->

            <div class="col-sm-4">
                <h5 class="title" style="color:<?php echo COR3;?>!important;">Fale Conosco</h5>
                <ul class="list alt-list col-sm-6">
                  <li>atendimento@agenciacodelabs.com</li>
                  <li class="whats">(43) 98484-1900 - Whatsapp</li>
                </ul>
            </div><!-- end col -->
            <div class="col-sm-3">
                <h5 class="title" style="color:<?php echo COR3;?>!important;">Baixe o App</h5>
                <div class="baixarapp">
                    <img src="<?php echo base_url('assets/site/')?>img/apple.png" style="width:100%;">
                    <img src="<?php echo base_url('assets/site/')?>img/playstore.png" style="width:100%;">
                </div>
                <h5 class="title" style="color:<?php echo COR3;?>!important;">Acompanhe-nos</h5>
                <div class="redessociais">
                    <i class='fab fa-facebook-square'></i>
                    <i style="background: black; font-size: 20px;" class='fab fa-instagram'></i>
                </div>
            </div><!-- end col -->
            <div class="col-sm-3">
        ...
        <div class="row text-center">
            ...
            <div class="col-sm-6">
                <p class="text-sm descricao" style="color:<?php echo COR3;?>!important; float: right;">&COPY; <?php echo date('Y');?>. © 2010-2022 CIDADE OFERTA SERVICOS DE INTERNET LTDA. Todos os direitos reservados. CNPJ 12.406.196/0001-06 Av. Ayrton Senna da Silva, 300 - Sala 101 . CEP 86050-460 . Gleba Fazenda Palhano . Londrina/PR</a></p>
            </div><!-- end col -->
        </div><!-- end row -->
    </div><!-- end container -->
</footer>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.6.2/nouislider.min.js"></script>
...
<div class="modal fade account registerModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <select class="form-control input-lg" name="localidadeHome" id="localidadeHome">
                    ...
                    <div class="col-sm-6 vertical-align image-background layer-dark" style="">
...
<?php
if(isset($promobanner) and !empty($promobanner)):
?>
<script>
    $(document).ready ( function(){
...
<div class="modal fade in" id="popupPromo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">

            <div class="modal-body">
                <img src="<?php echo base_url('web/imagens/'.$promobanner)?>" style="width: 100%;height: 100%">
            </div>
