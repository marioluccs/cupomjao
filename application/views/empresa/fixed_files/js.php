...
<script src="<?php echo base_url('assets/empresa')?>/plugins/bootstrap-sweetalert/sweet-alert.min.js"></script>
<script src="<?php echo base_url('assets/empresa')?>/pages/jquery.sweet-alert.init.js"></script>

<!-- Counter Up  -->
<script src="<?php echo base_url('assets/empresa');?>/plugins/waypoints/lib/jquery.waypoints.js"></script>
<script src="<?php echo base_url('assets/empresa');?>/plugins/counterup/jquery.counterup.min.js"></script>
...
<script>
    function logout() {
        ...
        $.ajax({
            url: '<?php echo base_url('AjaxEmpresa/logout')?>',
            type: 'POST',
            beforeSend: function () {
            ...
            error: function (res) {
                ...
                Command: toastr["error"]('Erro ao realizar o Logout!');
...
<script>
    ...
    $(function(){
        ...
        $('.valor_mask').bind('keyup',mask.money);
    });
