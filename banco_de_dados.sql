...
--
-- Host: localhost
-- Tempo de geração: 11/08/2021 às 04:54
...
INSERT INTO `categorias` (`id`, `nome`, `ordem`, `status`) VALUES
(2, 'Gastronomia', 1, 1),
(4, 'Saúde e Beleza', 2, 1),
(7, 'Moda', 4, 1),
(8, 'Eventos', 12, 1),
(9, 'Produtos & Serviços', 3, 1),
(10, 'Turismo', 11, 1),
(11, 'Classificados', 10, 1),
(12, 'Casa & Construção', 8, 1),
(14, 'Idiomas e Ensino', 9, 1),
(15, 'Supermercados', 0, 1),
(16, 'Ofertas Exclusivas', 0, 1);

-- --------------------------------------------------------

--
-- Estrutura para tabela `colunasofertas`
--
...
--
-- Despejando dados para a tabela `colunasofertas`
--
...
--
-- Despejando dados para a tabela `menu_admin`
--
...
(4, 'Categorias', 'categorias', 'id,nome,status', 'id,nome,status', 2, 3, '', 1, 'fa fa-bars', 1),
(5, 'Produtos', 'produtos', 'id,image,nome,categorias,status', 'id,nome,CONTAINER,breve_descricao,descricao,regras_de_uso,empresas,cronometro,opcao,quantidade,valor,desconto,opcao2,valor2,desconto2,valido,tipoProd,categorias,image,image2,image3,image4,image5,image6,promobanner,status', 2, 1, '', 1, 'fa fa-shopping-cart ', 1),
...
--
-- Estrutura para tabela `menu_admin_categorias`
--
...
--
-- Despejando dados para a tabela `menu_admin_categorias`
--
...
INSERT INTO `produtos` (`id`, `destaque`, `nome`, `CONTAINER`, `empresas`, `quantidade`, `breve_descricao`, `descricao`, `regras_de_uso`, `opcao2`, `valor2`, `opcao`, `valor`, `tipoProd`, `desconto`, `desconto2`, `categorias`, `localidade`, `valido`, `image`, `image2`, `image3`, `image4`, `image5`, `image6`, `image7`, `image8`, `promobanner`, `selo`, `cronometro`, `status`) VALUES
(45, 1, 'Exemplo 1 - Demonstrativo Agência CodeLabs em Minas Gerais', 7, 32, 1000, 'Exemplo 1 - Demonstrativo Agência CodeLabs em Minas Gerais', '<p><span style=\"color: rgb(114, 111, 111); font-family: Poppins, sans-serif; font-size: 16px;\">O Sistema de Cupom Descontos é um site de anúncios voltado para anúncio de empresas e serviços de descontos. Altamente lucrativo e de fácil administração é um sistema totalmente desenvolvido pela Agência CodeLabs. Se você ou sua empresa presta serviços de qualidade e está precisando divulgar empresas e descontos, este é o sistema.</span><br></p>\r\n\r\n<script>\r\n    $(document).ready ( function(){\r\n        setTimeout(() => {  $(\'#popupPromo\').modal(\'show\'); }, 5000);\r\n    });\r\n</script>', '<p><span style=\"color: rgb(114, 111, 111); font-family: Poppins, sans-serif; font-size: 16px;\">O Sistema de Cupom Descontos é um site de anúncios voltado para anúncio de empresas e serviços de descontos. Altamente lucrativo e de fácil administração é um sistema totalmente desenvolvido pela Agência CodeLabs. Se você ou sua empresa presta serviços de qualidade e está precisando divulgar empresas e descontos, este é o sistema.</span><br></p>', '', '', 'Agência CodeLabs', '100.00', 0, '10.00', '', 16, 1, '12/31/2022', '10082021_486401777binance logo.png', '10082021_455223507layout3.png', '', '', '', '', '', '', '10082021_270874105binance logo.png', 0, 1, 1),
...
--
-- Despejando dados para a tabela `recupera_senha`
--
...
--
-- Estrutura para tabela `validados`
--
...
--
-- Despejando dados para a tabela `validados`
--
...
--
-- Índices de tabela `colunasofertas`
--
...
--
-- Índices de tabela `menu_admin_categorias`
--
...
--
ALTER TABLE `produtos`
  MODIFY `id` int(99) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
